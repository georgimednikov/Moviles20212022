...
public class AdManager : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, IUnityAdsInitializationListener
{
    ...
    public void ShowAd(AdId adId)
    {
        ...
        {
            // Pedro Pablo: en el editor parece que funciona de manera diferente a en el movil, a�adiendo todo el rato a los listeners en el primero, y en el segundo quitandolo cuando acaba.
